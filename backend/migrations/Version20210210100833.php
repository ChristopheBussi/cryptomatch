 ...
 */
final class Version20210210100833 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE rank_valorisation_amount rank_valorisation_amount DOUBLE PRECISION DEFAULT NULL');
    }
}
