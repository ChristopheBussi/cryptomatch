 ...
 */
final class Version20210215115307 extends AbstractMigration
{
...
<<<<<<< HEAD:backend/migrations/Version20210211102600.php
        // $this->addSql('CREATE TABLE crypto (id INT AUTO_INCREMENT NOT NULL, pair_name VARCHAR(255) NOT NULL, image_url VARCHAR(300) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        // $this->addSql('CREATE TABLE portfolio (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, actual_quantity DOUBLE PRECISION NOT NULL, average_price DOUBLE PRECISION NOT NULL, INDEX IDX_A9ED1062A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
=======
        $this->addSql('CREATE TABLE crypto (id INT AUTO_INCREMENT NOT NULL, pair_name VARCHAR(255) NOT NULL, image_url VARCHAR(255) DEFAULT NULL, symbol VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, price_change_percent24h DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE portfolio_crypto ADD CONSTRAINT FK_6EC3C5B0B96B5643 FOREIGN KEY (portfolio_id) REFERENCES portfolio (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE portfolio_crypto ADD CONSTRAINT FK_6EC3C5B0E9571A63 FOREIGN KEY (crypto_id) REFERENCES crypto (id) ON DELETE CASCADE');
>>>>>>> RecordOrders:backend/migrations/Version20210215115307.php
    }
